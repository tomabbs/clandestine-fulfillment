...
import { deleteView, listViews, saveView, setDefaultView, type SavedView } from "@/actions/user-views";
...
export function CockpitSavedViews({ currentViewState, onLoadView }: CockpitSavedViewsProps) {
  ...
  useEffect(() => {
    ...
    if (def) {
      onLoadView(def.view_state);
    }
    if (viewsQuery.data) setDefaultLoaded(true);
  }, [viewsQuery.data, defaultLoaded, onLoadView]);
    ...
    <div className="flex items-center gap-2">
      <Select
        ...
        onValueChange={(v) => {
          ...
          if (view) onLoadView(view.view_state);
        }}
      >
